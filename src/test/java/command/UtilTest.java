...
public class UtilTest {
    ...
    public void verifyFileName() throws Exception {
        String outfileName=Util.verifyFileName("E:\\test\\java\\test_data.java");
    ...
    public void generateOutfileName() throws Exception {
        ...
        * */
        String outfileName=Util.generateOutfileName("data.json","test1/java/test.java.ftl");
