...
import com.cffex.demo.advanced.bean.Course;
import com.cffex.demo.bean.Course;
...
public interface CourseService {
	...
	public List<Course> findAllByPageNum(int pageNum, int pageSize);

	public List<Course> findByTitle(String title, int pageNum, int pageSize);
	...
	//调用CourseService
	public List<Course> callService();
